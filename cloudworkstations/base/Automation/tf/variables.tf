...
variable "activate_apis" {
  ...
  type        = list(string)
  default     = ["serviceusage.googleapis.com", "compute.googleapis.com", "workstations.googleapis.com", "artifactregistry.googleapis.com", "cloudbuild.googleapis.com", "logging.googleapis.com", "monitoring.googleapis.com"]
}
