...
`europe-docker.pkg.dev/coffee-plantation/workstation/geminicli-builder:latest`
...
```yaml
steps:
- name: 'europe-docker.pkg.dev/coffee-plantation/workstation/geminicli-builder'
